// C++ - Variadics
// Create a template function named reversed_binary_value. It must take an arbitrary 
// number of bool values as template parameters. These booleans represent binary digits 
// in reverse order. Your function must return an integer corresponding to the binary 
// value of the digits represented by the booleans. For example: reversed_binary_value<0,0,1>() 
// should return 4
